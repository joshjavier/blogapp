...
describe('favorite blog', () => {
  ...
  it('returns the only item of a list with one item', () => {
  ...
  it('returns the blog with the most number of likes', () => {
...
describe('most likes', () => {
  it('returns the author whose blog posts have the largest total number of likes', () => {
